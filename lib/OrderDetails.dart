...
class _OrderDetailsState extends State<OrderDetails> {
  ...
  static const _initialCameraPosition =
      CameraPosition(target: LatLng(13.3461, 74.7965), zoom: 13);
                  ...
                  setState(() {
                    _markers.add(Marker(
                        ...
                        infoWindow: InfoWindow(
                            title: 'Source', snippet: 'details here*')));
                  });
                },
              ),
              Positioned(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Column(
                        children: [
                          Text('Order No: xx', style: TextStyle(fontSize: 20)),
